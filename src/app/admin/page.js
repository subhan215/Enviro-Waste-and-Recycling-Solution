...
export default function AdminPanel() {
  ...
  return (
    <div className="flex h-screen bg-white text-custom-green">
      {/* Sidebar */}
      <aside className="w-64 min-w-64 bg-white text-custom-black border-r">
        <div className="p-4">
  ...
  {["Dashboard", "Complaints", "Reward requests", "Resign agreements", "Area approval requests" , "Recycling requests"].map((tab) => (
    <li key={tab}>
      <button
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-5.25h5.25M7.5 15h3M3.375 5.25c-.621 0-1.125.504-1.125 1.125v3.026a2.999 2.999 0 0 1 0 5.198v3.026c0 .621.504 1.125 1.125 1.125h17.25c.621 0 1.125-.504 1.125-1.125v-3.026a2.999 2.999 0 0 1 0-5.198V6.375c0-.621-.504-1.125-1.125-1.125H3.375Z" />
      ...
      <main className="flex-1 p-8 bg-green-50">
        ...
        {activeTab === "Dashboard" && (
          <div>
            <h2 className="text-2xl font-bold mb-4 text-custom-black">Dashboard Overview</h2>
        ...
        {activeTab === "Complaints" && (
          <div>
            <h2 className="text-2xl font-bold mb-4 text-custom-black">Citizen Complaints</h2>
            <ComplaintsTable
        ...
        {activeTab === "Reward requests" && (
          <div>
            <h2 className="text-2xl font-bold mb-4 text-custom-black">Reward Conversion Requests</h2>
        ...
        {activeTab === "Resign agreements" && (
          <div>
            <h2 className="text-2xl font-bold mb-4 text-custom-black">Resign Agreements Requests</h2>
            <ResignAgreements
              searchTerm={searchTerm}
              setSearchTerm={setSearchTerm}
              statusFilter={statusFilter}
