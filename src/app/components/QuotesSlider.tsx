  ...
  return (
    <section className="py-24 bg-green-100">
      <div className="container mx-auto px-4">
        <motion.h2 
          className="text-4xl font-bold text-center mb-12 text-custom-black"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {quotes.map((quote, index) => (
            ...
            >
              <p className="text-lg mb-4 text-gray-800">{quote.text}</p>
              <p className="font-semibold text-green-700">- {quote.author}</p>
            </motion.div>
          ))}
        </div>
      </div>
