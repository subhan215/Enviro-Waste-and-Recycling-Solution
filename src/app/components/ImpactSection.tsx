  ...
  return (
    <section className="py-24 bg-green-100">
      <div className="container mx-auto px-4">
        <h3 className="text-4xl font-semibold text-center mb-16 text-custom-black">Our Environmental Impact</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {impacts.map((impact, index) => (
            ...
            >
              ...
              <h4 className="text-2xl font-semibold mb-2 text-green-800">{impact.value}</h4>
